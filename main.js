(() => {
  ...
  function c(e, n) {
    ...
    var y = new Date(0);
    y.setUTCFullYear(w + 1, 0, b), y.setUTCHours(0, 0, 0, 0);
    var p = l(y, n),
      T = new Date(0);
    T.setUTCFullYear(w, 0, b), T.setUTCHours(0, 0, 0, 0);
    var C = l(T, n);
          ...
          i =
            ...
            (function (e, n) {
              ...
              var g = d(),
                ...
                b = new Date(0);
              return (
                b.setUTCFullYear(v, 0, w), b.setUTCHours(0, 0, 0, 0), l(b, n)
              );
            })(o, n).getTime();
    ...
    match: {
      ordinalNumber:
        ...
        function (t) {
          ...
          if (!a) return null;
          var o = F.valueCallback ? F.valueCallback(a[0]) : a[0];
          return {
  ...
  var I = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,
    ...
    X = /[a-zA-Z]/;
  function R(n, o, i) {
    var u, s, l, c, m, h, f, g, w, v, b, y, p, T, C, M, D, k;
    t(2, arguments);
    var x = String(o),
      U = d(),
      P =
    ...
    return x
      ...
      .map(function (t) {
        ...
        var e,
          r,
          a = t[0];
        if ("'" === a) return (r = (e = t).match(A)) ? r[1].replace(G, "'") : e;
        var u,
          s = S[a];
        if (s)
          return (
  ...
  const $ = document.getElementById("currentWeather"),
    ...
    V = document.getElementById("currentTime"),
    K = document.getElementById("temperature"),
    Z = document.getElementById("feelsLike"),
    tt = document.getElementById("humidity"),
    et = document.getElementById("windSpeed"),
    nt = {
      showData: function (t) {
        ...
        !(function (t) {
          ...
          (function (t, e) {
            ...
            (Z.textContent = `${n.format(t.feels_like)}`),
              (tt.textContent = `${t.humidity}%`),
              (et.textContent = `${e.speed} km/h`);
          })(n, a),
          (function () {
            const t = R(new Date(), "MMM dd, yyyy");
            _.textContent = t;
            const e = `${new Date().getHours()}:${new Date().getMinutes()}`;
            V.textContent = e;
          })();
      },
    },
    rt = document.getElementById("Error");
  async function at(t = "Windhoek") {
    try {
      const e = await fetch(
